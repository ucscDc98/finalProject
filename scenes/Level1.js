class Level1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.anchor5 = this.physics.add.sprite(this.rock12.x + 850, -600, 'anchor').setScale(4);
        this.anchor5.body.setVelocityY(300);
        this.anchor6 = this.physics.add.sprite(this.anchor5.x + 550, -750, 'anchor').setScale(4);
    ...
    update() { 
        ...
        if (Math.abs(this.pufferFish.x - this.shark1.x) < 1000 && Math.abs(this.pufferFish.y - this.shark1.y) < 1000 && this.pufferFishShape == 'fat') {
            ...
            if(this.j == 0) {
                this.shark1Sound.play(this.shark1Config);
            }
            this.j++;
        }
        if (Math.abs(this.pufferFish.x - this.shark2.x) < 1000 && Math.abs(this.pufferFish.y - this.shark2.y) < 1000 && this.pufferFishShape == 'fat') {
            ...
            if(this.j == 0) {
                this.shark2Sound.play(this.shark2Config);
            }
            this.j++;
        }
